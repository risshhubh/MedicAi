...
export default function Login() {
  ...
  if (loading) return <LoadingScreen message="Signing you in to MedicAi..." />;
        ...
        >
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                className="group flex w-full justify-center items-center rounded-xl bg-teal-600 px-3 py-3.5 text-sm font-semibold text-white shadow-xl shadow-teal-600/30 hover:bg-teal-700 transition-all hover:-translate-y-0.5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-600"
              >
                Sign in
